<template>
	<view class="tui-textarea__wrap"
		:class="{'tui-textarea__border-top':borderTop && !textareaBorder,'tui-textarea__border-bottom':borderBottom && !textareaBorder,'tui-textarea__border-nvue':textareaBorder,'tui-textarea__flex-start':flexStart}"
		...
		<view class="tui-textarea__flex-1">
			<textarea class="tui-textarea__self" :class="{'tui-textarea__text-right':textRight,'tui-textarea__disabled':disabled}"
				:style="{height:height,minHeight:minHeight,fontSize:size+'rpx',color:color}"
				placeholder-class="tui-placeholder" :name="name" :value="inputVal"
				:placeholder="inputVal?'':placeholder" :placeholderStyle="placeholderStyl" :disabled="disabled"
...
<style>
	...
	.tui-textarea__text-right {
		text-align: right;
	}
	.tui-textarea__disabled {
		pointer-events: none;
	}
</style>